...
export default function HomeScreen() {
  ...
  const energyLevels: { level: EnergyLevel; label: string; description: string; icon: string }[] = [
    { level: 'very-low', label: energyLevelLabels['very-low'], description: energyLevelDescriptions['very-low'], icon: 'battery.0' },
    { level: 'low', label: energyLevelLabels['low'], description: energyLevelDescriptions['low'], icon: 'battery.25' },
    { level: 'moderate', label: energyLevelLabels['moderate'], description: energyLevelDescriptions['moderate'], icon: 'battery.50' },
    { level: 'high', label: energyLevelLabels['high'], description: energyLevelDescriptions['high'], icon: 'battery.100' },
  ];
